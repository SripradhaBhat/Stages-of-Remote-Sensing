...
void cloud(int x, int y)
{
	...
	glColor3f(0, 0, 0);
	int s;
	glRasterPos2i(-255, 200);                                                    //displays college name
...
void explain2()
{
	...
	glColor3f(1, 1, 1);
	int s;
	glRasterPos2i(-580,470);                                                    //displays college name
	for (s = 0; e[s] != '\0'; s++)
	{
		glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18, e[s]);
	}
	glRasterPos2i(-580, 430);                                                    //displays college name
	for (s = 0; f[s] != '\0'; s++)
	{
...
void drawsun()
{
	...
	glColor3f(0, 0, 0);
	int s;
	glRasterPos2i(-455, 285);                                                    //displays college name
...
void river() {
	...
	glColor3f(0, 0, 0);
	int s;
	glRasterPos2i(-450, -240);                                                    //displays college name
...
void tree()
{
	...
	glColor3f(0, 0, 0);
	int s;
	glRasterPos2i(-500, -185);                                                    //displays college name
	glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18, 'C');
	glFlush();
}
...
void DrawSatellite()
{
	...
	glColor3f(1, 1, 1);
	int s;
	glRasterPos2i(325, 125);                                                    //displays college name
...
void image()
{
	...
	glColor3f(1, 1, 1);
	int s;
	glRasterPos2i(5, 180);                                                    //displays college name
...
void thirdscreen()
{
	...
	glColor3f(1, 1, 1);
	int s;
	glRasterPos2i(5, 60);                                                    //displays college name
